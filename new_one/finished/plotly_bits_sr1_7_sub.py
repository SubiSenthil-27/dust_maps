...
b_max = 5
b_min = -5
d_near = 0.5  # front face (near)
d_far  = 0.8  # back face (far)
...
b_max = 5
b_min = -5
d_near = 0.8  # front face (near)
d_far  = 1.3  # back face (far)
...
b_max = 2.6
b_min = -3.7
d_near = 1.3  # front face (near)
d_far  = 2.4  # back face (far)
...
b_max = 2
b_min = -2
d_near = 3.7  # front face (near)
d_far  = 4.5  # back face (far)
